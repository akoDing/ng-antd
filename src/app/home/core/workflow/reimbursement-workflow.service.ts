...
export class ReimburseWorkflowService {
    ...
    getOverAllTasks(): Observable<any> {
        return this.apiService.pipeApi(this.apiService.get('appbiz/reimbursement/tasks/groups'));
    }
    getTasks(data): Observable<any> {
        return this.apiService.pipeApi(this.apiService.get('appbiz/reimbursement/tasks/bydefkey', data));
    }
